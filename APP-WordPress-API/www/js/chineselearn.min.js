...
.constant('AppConfig', {
    appName: 'Chinese Learn InfoCenter',
    domainURI: 'http://chineselearn.info/',
    wpAPIURI: 'wp-json/wp/v2/',
    wpAPIKey: '',
    wpAPISecret: '',
    wpAPIURIsuffix: 'orderby=id&order=asc&per_page=',
    wpAPIRSlimit: 10,
    ...
    contactForm2Email: 'info@chineselearn.info',
    contactForm2User: 'InfoSupport',
    eeConnectTimeout: 10000,
    areaList: ['tw-taipei-xinbei-keelung', 'tw-taoyuan-hsinchu-miaoli', 'tw-taichung-changhua-nantou', 'tw-yunlin-chiayi-tainan', 'tw-kaohsiung-pingtung', 'tw-ilan-hualien-taitung']
});
